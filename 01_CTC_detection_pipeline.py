...
def preprocessing(num,name):  
    ...
    gray_adapteq = exposure.equalize_adapthist(gray,kernel_size=(70,70), clip_limit=0.05)  # è‡ªé€‚åº”å‡è¡¡
...
def yellow(num,cmask1,nmask1,img_c,img_nucle_rescale):
    ...
    #gray_adapteq_C = exposure.equalize_adapthist(img_c,kernel_size=(5,5), clip_limit=0.05)  # è‡ªé€‚åº”å‡è¡¡
#    plt.imshow(gray_adapteq)
...
def cell_detection(inputt):
    ...
    plt.imshow(img)
    cellmask2,cell_minus=segmentation_diff(num,img_c,enh_c,backg_c,nuc_wat_th,name)
    ...
    f = open(f"/home/Yuni/CTC/01.1_patients_samples/02_segmentation_results/{n}.{num}.result.pkl", 'wb')
...
Path="/home/Yuni/CTC/01.3_healthy_patients/01_1_data_healthy/01_0902_healthy_data/"
subfolder=os.listdir(Path)
imagePAll=[]
for sub in subfolder:
    imagePAll.append(Path+sub)
    
# imagePAll.append("/home/Yuni/CTC/01.1_patients_samples/01_data_images/20191203/191203-112511000010035+T")
# imagePAll.append("/home/Yuni/CTC/01.1_patients_samples/01_data_images/20191205/191205-112511004010024")
# imagePAll.append("/home/Yuni/CTC/01.1_patients_samples/01_data_images/20191205/191205-112511004010023")
# imagePAll.append("/home/Yuni/CTC/01.1_patients_samples/01_data_images/20191211/191211-19B00100018")
# imagePAll.append("/home/Yuni/CTC/01.1_patients_samples/01_data_images/20191201/191201-112510000010022")
# imagePAll.append("/home/Yuni/CTC/01.1_patients_samples/01_data_images/20191211/191211-19B00100034")
